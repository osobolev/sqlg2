...
public JavaLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("interface", this), new Integer(12));
	literals.put(new ANTLRHashString("class", this), new Integer(11));
	literals.put(new ANTLRHashString("final", this), new Integer(19));
	literals.put(new ANTLRHashString("transient", this), new Integer(22));
	literals.put(new ANTLRHashString("import", this), new Integer(13));
	literals.put(new ANTLRHashString("private", this), new Integer(16));
	literals.put(new ANTLRHashString("synchronized", this), new Integer(21));
	...
	literals.put(new ANTLRHashString("volatile", this), new Integer(23));
	literals.put(new ANTLRHashString("strictfp", this), new Integer(24));
	literals.put(new ANTLRHashString("public", this), new Integer(14));
	literals.put(new ANTLRHashString("native", this), new Integer(20));
}
...
tryAgain:
	...
	public final void mSL_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if ( inputState.guessing==0 ) {
			_ttype = doWhiteSpace(_ttype); doNewLine();
		}
		if ( _createToken && _token==null && _ttype!=Token.SKIP ) {
			_token = makeToken(_ttype);
			_token.setText(new String(text.getBuffer(), _begin, text.length()-_begin));
