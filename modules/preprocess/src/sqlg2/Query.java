 ...
 * {@link sqlg2.db.QueryPiece} can be used to build larger SQL statement from pieces.
 * <p>
 * Example:
 * <pre>
 * int idParam = ...;
 ...
 * </pre>
 * Preprocessor generates code to encapsulate SQL text and parameters in the {@link sqlg2.db.QueryPiece} object.
 * <p>
